...
export function migrationsDirectory(moduleFile = thisFile): string {
  return path.resolve(path.dirname(moduleFile), "../db/migrations");
}
...
Applies pending apps/api/db/migrations/*.sql files once.
