...
- [x] Run the full gate and compose smoke test; verified with `npm run check` and `docker compose -f compose.dev.yaml up --build -d` plus `curl http://127.0.0.1:3000/api/me`.
