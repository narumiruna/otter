...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Add split select/clear shortcuts | Medium | Low | High | High | High | High | Low | Low | Completed this cycle: helps large groups adjust expense splits without unchecking people one by one. |
...
| 5 | Add CSV import for expenses | Medium | Medium | Medium | Low | Medium | Medium | High | Medium | Later: more parsing/validation surface than UI split shortcuts. |
