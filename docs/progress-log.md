...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Reject invalid trip base currency on create | Medium | High | High | High | High | High | Low | Low | Completed this cycle: makes create validation match edit validation and avoids silently creating trips in TWD. |
...
| 5 | Add CSV import for expenses | Medium | Medium | Medium | Low | Medium | Medium | High | Medium | Later: more parsing/validation surface than base currency validation. |
