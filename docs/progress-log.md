...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Edit expense payer | High | High | Medium | Medium | High | High | Medium | Medium | Completed this cycle: fixes wrong settlement direction without changing split set. |
| 2 | Edit expense split participants | High | High | Medium | Medium | Medium | Medium | Medium | Medium | Next likely candidate, but needs better multi-select UX. |
