...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Add CSV export | Medium | Low | High | High | High | High | Low | Low | Completed this cycle: lets users take trip expenses to spreadsheets without backend changes. |
| 2 | Add date editing | Medium | Medium | Medium | Medium | High | Medium | Medium | Low | Next likely candidate: useful follow-up now that date exists. |
